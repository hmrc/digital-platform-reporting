...
enum CadxValidationError {
  case FileError(submissionId: String, operatorId: String, code: String, detail: Option[String], created: Instant)
  case RowError(submissionId: String, operatorId: String, code: String, detail: Option[String], docRef: String, created: Instant)
}
